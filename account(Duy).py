...
class Account:
    ...
    def Edit_Account(self, balance: int, accountType: str, accountName: str):
        ...
        try: 
            ...
            messagebox.showerror("Notification","Balance must be integer number")
        
        
        
    """Make money transfers between internal accounts"""
    def Create_Transfer(self, destinationAccount: str, amount: int, time: str = "DD/MM/YYYY"):
        if time == "DD/MM/YYYY":
            time = GetPresentTime()
    ...
    def Create_Transaction(self, transactionType: str, amount: int, time: str = "DD/MM/YYYY", note: str = ""):
        if time == "DD/MM/YYYY":
             GetPresentTime()
    ...
    """Create a new Debt"""
    def Create_Debt(self, debtType: str, amout: int, interestRate: float, status: bool, debtDate: str = "DD/MM/YYYY", dueDate: str = "DD/MM/YYYY"):
        if time == "DD/MM/YYYY":
            time = GetPresentTime()
